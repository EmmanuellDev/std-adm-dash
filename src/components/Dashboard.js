...
import { FaUser, FaGraduationCap, FaUniversity, FaCalendarAlt, FaBook, FaSignOutAlt, FaChartLine, FaCalendar } from "react-icons/fa";
      ...
      if (user) {
        try {
          ...
          if (!querySnapshot.empty) {
            ...
            setUpcomingEvents(mockApi.getUpcomingEvents(userDoc.department, userDoc.year));
          } else {
      ...
      <div className="bg-black/80 backdrop-blur-3xl p-12 rounded-3xl w-full max-w-6xl mx-auto border border-cyan-500/40 shadow-[0_0_50px_rgba(0,255,255,0.5)] transition-all hover:shadow-[0_0_70px_rgba(0,255,255,0.7)] relative overflow-hidden group mt-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/3 bg-black/30 p-6 rounded-lg border border-cyan-500/50">
            <h3 className="text-2xl font-bold text-cyan-400 mb-6 font-futuristic">Profile</h3>
            <div className="space-y-6">
              <div className="relative group">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-gray-400 text-sm font-futuristic">Name</p>
                    <p className="text-gray-100 text-lg font-futuristic">{userData?.name}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative group">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-gray-400 text-sm font-futuristic">Email</p>
                    <p className="text-gray-100 text-lg font-futuristic">{userData?.email}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative group">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-gray-400 text-sm font-futuristic">Degree</p>
                    <p className="text-gray-100 text-lg font-futuristic">{userData?.degree}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative group">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-gray-400 text-sm font-futuristic">Department</p>
                    <p className="text-gray-100 text-lg font-futuristic">{userData?.department}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative group">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-gray-400 text-sm font-futuristic">Year</p>
                    <p className="text-gray-100 text-lg font-futuristic">{userData?.year}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative group">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-gray-400 text-sm font-futuristic">Course</p>
                    <p className="text-gray-100 text-lg font-futuristic">{userData?.course}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:w-2/3 space-y-8">
            ...
            <div>
              <h3 className="text-2xl font-bold text-cyan-400 mb-4 font-futuristic">Course Progress</h3>
              <div className="relative group bg-black/30 p-6 rounded-lg border border-cyan-500/50">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div>
                    <p className="text-gray-100 text-lg font-futuristic">{courseProgress?.course}</p>
                    <p className="text-gray-400 text-sm font-futuristic">Last Updated: {courseProgress?.lastUpdated}</p>
                  </div>
                </div>
                ...
                <p className="text-gray-100 text-sm mt-2 font-futuristic">{courseProgress?.progress}% Complete</p>
              </div>
            </div>

            {/* Upcoming Events */}
            <div>
              <h3 className="text-2xl font-bold text-cyan-400 mb-4 font-futuristic">Upcoming Events</h3>
              <div className="grid grid-cols-1 gap-4">
                {upcomingEvents.map((event) => (
                  <div key={event.id} className="relative group bg-black/30 p-6 rounded-lg border border-pink-500/50">
                    <div className="flex items-center space-x-3">
                      <div className="relative">
                      ...
                      <div>
                        <p className="text-gray-100 text-lg font-futuristic">{event.title}</p>
                        <p className="text-gray-400 text-sm font-futuristic">{event.date}</p>
                        <p className="text-gray-100 text-sm mt-2 font-futuristic">{event.description}</p>
                      </div>
                    </div>
                  </div>
                ))}
